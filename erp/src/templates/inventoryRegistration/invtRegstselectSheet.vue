<template>
 <el-dialog id="invtRegstselectSheet" :before-close="close" width="61%" title="入库单" style="text-align: center;" :visible.sync="invtRegstreviewSheet_gascheduling_dialog_visible">
