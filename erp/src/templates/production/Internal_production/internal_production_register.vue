<template>
	<div id="internal_production">
		<register :manufacture="activeManufacture" v-model="register_dialog_visible"></register>
		<el-table  :border="true" @row-dblclick="register"
		 ...
		 :default-sort="{prop:'manufacture_id',order:'descending'}">
			...
			<el-table-column label="操作">
				<template slot-scope="scope">
					<el-button size="small" @click="register(scope.row)" type="primary" title="制定单登记" >登记</el-button>
				</template>
			</el-table-column>
		</el-table>
	</div>
...
<script>
	import register from '@/components/internal_production/register.vue'
	export default{
