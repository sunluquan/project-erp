<template>
	<el-dialog :before-close="close" title="新增派工单" :visible.sync="dialog_visible">
		<div id="columns"> 
		...
		<div id="columns">
			<el-form label-position="left" inline class="demo-table-expand">
				<el-form-item label="设计人: ">
					<el-input v-model="manufacture.designer" placeholder="请输入设计人"></el-input>
				</el-form-item>
		...
		<div slot="footer" class="dialog-footer">
			...
			<el-button type="primary" @click="pass">提 交</el-button>
		</div>
	</el-dialog>
</template>
...
<script>
	export default{
		...
		data(){
			...
			// getManufacture(){
			// 	let params=this.$store.getters.getManufacture//this.$route.params[Object.keys(this.$route.params)[0]]
			// 	this.manufacture=params;
			// 	this.$axios.get('/api/porcessDesign/byProductId')
			// 		.then(response=>{
						
			// 		})
			// }
			getManufacture(){
				let params=this.$route.params[Object.keys(this.$route.params)[0]]
				params=JSON.parse(params)
				this.$axios.post('/api/manufacture/getInsert',params)
					.then(response=>{
